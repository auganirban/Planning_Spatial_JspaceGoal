function [thetha_next, ip_task2js] = theta_next_robust_config( J_s, g_t, result, theta_t, theta_goal, beta, alpha )
    ...
    if must_achieve_theta_goal
        thetha_next = theta_t + dth + alpha*(eye(7,7) - inv_Js*J_s)*(theta_goal - theta_t);
    else
